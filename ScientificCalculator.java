...
// package name is Scientific Calculators
import java.awt.EventQueue;
import javax.swing.JFrame;
import javax.swing.JMenuBar;
import javax.swing.JMenu;
import javax.swing.JMenuItem;
import javax.swing.JTextField;                   // all these statements which include "import" keyword are used to import some predefined java packages
...
public class ScientificCalculator {               //main class for this program
    ...
    double Nigerian_Naira = 5.20;
    double US_Dollar = 0.014;
    double Kenyan_Shilling = 1.46;
    double Brazilian_Real = 0.056;
    double Canadian_Dollar = 0.019;
    double Indian_Rupee = 1.00;
    double Philippine_Peso = 0.75;
    double Indonessia_Rupiah = 203.74;
    ...
    private void initialize() {
        ...
        frmStandardCalculator.setBounds(100, 100, 268, 355);
        ...
        mntmCurrencyConverter.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                frmStandardCalculator.setBounds(100, 100, 625, 367);
                txtDisplay.setBounds(10, 11, 243, 37);
            }
        });
